  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const response = await fetch('https://formspree.io/f/xpwrvzjo', {
          method: 'POST',
          headers: {
...
${data.message}
        ...
        const mailtoLink = `mailto:syedaqib2742@gmail.como:?subject=${emailSubject}&body=${emailBody}`;
